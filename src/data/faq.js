export const faqDataOne = [
    {
        "accKey":"1",
        "question":"How can I receive the reward?",
        "answer":"Receiving the reward is very simple, all you have to do is hold a minimum number of tokens until Easter Day, after which, via our platform (coming soon), you will be able to receive a reward in BNB.."
    },
    {
        "accKey":"2",
        "question":"What is the minimum number of tokens you need to hold to get the prize?",
        "answer":"To receive the reward you need to hold at least 0.5% of the total supply"
    },
    {
        "accKey":"3",
